...
export function Footer() {
  ...
  const columns: FooterColumn[] = [
    ...
    },
    {
      ...
      links: [
        { label: m["landing.footer.github"](), href: "https://github.com/BeatAPI/beatapi-saas-template", external: true },
      ],
    },
    {
  ...
  const socials: FooterSocial[] = [
    { icon: GithubIcon, href: "https://github.com/BeatAPI/beatapi-saas-template", label: "GitHub" },
  ];
