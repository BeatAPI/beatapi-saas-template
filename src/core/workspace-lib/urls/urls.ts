import { LOCALES, routing } from '@/core/workspace-lib/shims/i18n';
import type { Locale } from '@/core/workspace-lib/shims/next-intl';

const DEFAULT_PRODUCTION_BASE_URL = 'https://your-domain.com';
 ...
 *
 * Example:
 * Input: http://localhost:3020/api/auth/reset-password/token?callbackURL=/auth/reset-password
 * Output: http://localhost:3020/api/auth/reset-password/token?callbackURL=/zh/auth/reset-password
 *
 * Input: http://localhost:3020/api/auth/verify-email?token=eyJhbGciOiJIUzI1NiJ9&callbackURL=/dashboard
 * Output: http://localhost:3020/api/auth/verify-email?token=eyJhbGciOiJIUzI1NiJ9&callbackURL=/zh/dashboard
 *
 ...
 * @returns The normalized URL with current locale prefix and .mdx extension (e.g., /zh/docs/what-is-fumadocs.mdx)
 */
