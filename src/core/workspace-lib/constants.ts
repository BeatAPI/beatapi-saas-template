...
/**
 * Max reference image file size (50MB)
 */
export const REFERENCE_IMAGE_MAX_FILE_SIZE = 50 * 1024 * 1024;

/**
 * Max reference video file size (50MB)
 */
export const REFERENCE_VIDEO_MAX_FILE_SIZE = 50 * 1024 * 1024;

/**
 * Max reference audio file size (15MB)
 */
